...
2. Desenhando o fundo e o baralho (**1.0 ponto**):
...
3. Marque a pontuação (**1.0 ponto**):
...
## NÍVEL AVANÇADO
1. Atinja o nível anterior.
2. Adicione um contador de tempo (**2.0 ponto**):
...
## A+
1. Atinja o nível anterior.
1. Adicione uma tela inicial para o jogo. A tela deve possuir dois botões: "Iniciar" e "Sair". (**0.5 ponto**)
    - Ao clicar em "Iniciar", o jogo deve começar.
    - Ao clicar em "Sair", o jogo deve fechar.
2. Ao finalizar o jogo e o jogador chegar em uma das telas finais, adicione um botão "Reiniciar". (**0.5 ponto**)
